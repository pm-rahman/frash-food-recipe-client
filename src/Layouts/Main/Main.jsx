...
const Main = () => {
    return (
        <div>
            <NavMenu/>
            <Background>
            <span className="text-semibold text-sm font-normal flex items-center gap-2">EXCLUSIVE RECIPES <span className="bg-sky-500 py-1 px-4 rounded-full">25% OFF</span></span>
