    ...
    return (
        <div className="h-96 overflow-hidden relative flex items-center">
            ...
            <div className="text-slate-100 px-32">
                ...
                <h4 className="text-4xl font-semibold py-3">Our Spatial Discount<p className="flex gap-2"> Week is <Icon icon="fa-solid:running" /><Icon icon="fa-solid:running" /><Icon icon="fa-solid:running" /></p></h4>
